...
const config = {
  ...
  maxBet: toInt(process.env.MAX_BET, 10000000),
  greenMaxBet: toInt(process.env.GREEN_MAX_BET, 1000000),
  ...
  pokerShowdownSeconds: toInt(process.env.POKER_SHOWDOWN_SECONDS, 8),
