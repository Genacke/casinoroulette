...
const config = {
  ...
  pokerTableBuyIn: toInt(process.env.POKER_TABLE_BUY_IN, 1000000),
  pokerSmallBlind: toInt(process.env.POKER_SMALL_BLIND, 20000),
  pokerBigBlind: toInt(process.env.POKER_BIG_BLIND, 40000),
  ...
  connect4EntryFee: toInt(process.env.CONNECT4_ENTRY_FEE, 500000),
  connect4WinnerPayout: toInt(process.env.CONNECT4_WINNER_PAYOUT, 900000),
  ...
  skribblEntryFee: toInt(process.env.SKRIBBL_ENTRY_FEE, 100000),
  skribblDrawSeconds: toInt(process.env.SKRIBBL_DRAW_SECONDS, 60),
  skribblShowdownSeconds: toInt(process.env.SKRIBBL_SHOWDOWN_SECONDS, 8),
  skribblMinPlayers: toInt(process.env.SKRIBBL_MIN_PLAYERS, 2),
  skribblMaxPlayers: toInt(process.env.SKRIBBL_MAX_PLAYERS, 8),
  skribblHousePercent: toInt(process.env.SKRIBBL_HOUSE_PERCENT, 10),
  ...
  slotJackpotIncrement: toInt(process.env.SLOT_JACKPOT_INCREMENT, 10),
  slotMachineLockSeconds: toInt(process.env.SLOT_MACHINE_LOCK_SECONDS, 180),
