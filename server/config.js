...
const config = {
  ...
  jackpotContributionPercent: Number(
    process.env.JACKPOT_CONTRIBUTION_PERCENT || 1,
  ),
  initialJackpotPool: toInt(process.env.INITIAL_JACKPOT_POOL, 25000),
  minBet: toInt(process.env.MIN_BET, 100),
  maxBet: toInt(process.env.MAX_BET, 500000),
